      ...
      <footer className="bg-[#222222] pt-[85px] pb-[22px] relative ">
        <div className="container">
          <div className="footer_row flex justify-end gap-[30px]">
            <ul>
              <li className="text-2xl font-semibold font-poppins text-white mb-[30px]">
                Contact
              </li>
              <li className="flex gap-[15px]">
                <LuMapPin className="text-[30px] text-brandColor " />
                <p className=" text-[14px] font-poppins font-normal text-[#CCCCCC] w-[215px]">
              ...
              <li className="flex gap-[15px] my-[25px]">
                ...
                <div>
                  <a
                    href={"tel:+91 987-654-3210"}
                    className=" text-[14px] font-poppins font-normal text-[#CCCCCC] w-[215px]"
                  >
                    +91 987-654-3210
                  </a>
                  <a
                    href={"tel:+91 123-456-7890"}
                    className=" text-[14px] font-poppins font-normal text-[#CCCCCC]  block w-[215px]"
                  >
                    +91 123-456-7890
                  </a>
                </div>
            ...
            <ul>
              ...
              <li>
                <Link
                  className="text-[16px] font-normal font-poppins text-[#CCCCCC] mb-[16px] inline-block"
                  to={"#"}
                >
                  Home
                </Link>
          ...
          <div className="flex justify-between py-[24px]">
            <p className="text-[14px] font-normal font-poppins text-[#999999]">
              Copyright 2024 All rights reserved.
            </p>
            <p className="text-[14px] font-normal font-poppins text-[#999999] flex items-center gap-[10px]">
              Crafted With <FaHeart /> by{" "}
              <span className="text-brandColor">DexignZone</span>{" "}
            </p>
          </div>
        </div>
